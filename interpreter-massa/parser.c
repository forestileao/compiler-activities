...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_NUMBER = 8,               /* TOKEN_NUMBER  */
  YYSYMBOL_TOKEN_OPERATOR = 9,             /* TOKEN_OPERATOR  */
  YYSYMBOL_10_ = 10,                       /* ';'  */
  YYSYMBOL_11_ = 11,                       /* '='  */
  YYSYMBOL_12_ = 12,                       /* '('  */
  YYSYMBOL_13_ = 13,                       /* ')'  */
...
{
       0,    28,    28,    30,    32,    33,    34,    37,    38,    39,
      40,    42,    44,    45,    46,    48,    50
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TOKEN_END", "TOKEN_WHILE", "TOKEN_DO", "TOKEN_ID", "TOKEN_NUMBER",
  "TOKEN_OPERATOR", "';'", "'='", "'('", "')'", "$accept", "program",
  "block", "statements", "statement", "assignment", "expression",
  "whileStmt", "call", YY_NULLPTR
};
